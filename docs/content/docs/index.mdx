...
---
---
import { Zap, Blocks, Pyramid, Ban, Users, AudioWaveform, Rabbit, ServerCog } from "lucide-react"
...
<Card
  ...
  href="https://discord.gg/Ff5FfJzq"
...
<Cards>
  ...
  <Card icon={<ServerCog />} title="Endpoints" href="./endpoints">Snapshot and gateway reference.</Card>
